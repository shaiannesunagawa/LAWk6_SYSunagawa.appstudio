...
const cacheName = 'LA6ShaianneSunagawa-2021-03-16 21:49:14.947737'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA6ShaianneSunagawa'.length) === 'LA6ShaianneSunagawa') {
